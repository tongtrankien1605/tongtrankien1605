!(function (t, e) {
    ...
    return (
                        ...
                        for (var r = this._hash.words, i = r[0], n = r[1], o = r[2], s = r[3], c = r[4], a = r[5], h = r[6], l = r[7], f = 0; f < 64; f++) {
                            f < 16
                                ...
                                : ((d = _[f - 15]),
                                  (u = _[f - 2]),
                                  (_[f] =
                                      (((d << 25) | (d >>> 7)) ^ ((d << 14) | (d >>> 18)) ^ (d >>> 3)) + _[f - 7] + (((u << 15) | (u >>> 17)) ^ ((u << 13) | (u >>> 19)) ^ (u >>> 10)) + _[f - 16]));
                            var d = (i & n) ^ (i & o) ^ (n & o),
                ...
                _doProcessBlock: function (t, e) {
                    for (
                        ...
                        var q = (F & W) ^ (~F & I),
                            ...
                            C = H,
                            A =
                                (N + ((((A >>> 28) | (H << 4)) ^ ((A << 30) | (H >>> 2)) ^ ((A << 25) | (H >>> 7))) + V + (J >>> 0 < G >>> 0 ? 1 : 0)) + ((H = ($ + J) | 0) >>> 0 < $ >>> 0 ? 1 : 0)) |
                                0;
                    }
                    (d = i.low = d + H),
        ...
        (x = u.create([
            5, 14, 7, 0, 9, 2, 11, 4, 13, 6, 15, 8, 1, 10, 3, 12, 6, 11, 3, 7, 0, 13, 5, 10, 14, 15, 8, 12, 4, 9, 1, 2, 15, 5, 1, 3, 7, 14, 6, 9, 11, 8, 12, 2, 10, 0, 4, 13, 8, 6, 4, 1, 3, 11, 15, 0,
            5, 12, 2, 13, 9, 7, 10, 14, 12, 15, 10, 4, 1, 5, 8, 7, 6, 2, 13, 14, 0, 3, 9, 11,
        ])),
        (b = u.create([
            11, 14, 15, 12, 5, 8, 7, 9, 11, 13, 14, 15, 6, 7, 9, 8, 7, 6, 8, 13, 11, 9, 7, 15, 7, 12, 15, 9, 11, 7, 13, 12, 11, 13, 6, 7, 14, 9, 13, 15, 14, 8, 13, 6, 5, 12, 7, 5, 11, 12, 14, 15, 14,
        ...
        (function () {
            var t = U,
                ...
                e = t.algo,
                h = [
                    57, 49, 41, 33, 25, 17, 9, 1, 58, 50, 42, 34, 26, 18, 10, 2, 59, 51, 43, 35, 27, 19, 11, 3, 60, 52, 44, 36, 63, 55, 47, 39, 31, 23, 15, 7, 62, 54, 46, 38, 30, 22, 14, 6, 61, 53,
                    45, 37, 29, 21, 13, 5, 28, 20, 12, 4,
                ],
                l = [
                    14, 17, 11, 24, 1, 5, 3, 28, 15, 6, 21, 10, 23, 19, 12, 4, 26, 8, 16, 7, 27, 20, 13, 2, 41, 52, 31, 37, 47, 55, 30, 40, 51, 45, 33, 48, 44, 49, 39, 56, 34, 53, 46, 42, 50, 36, 29,
                    32,
                ],
